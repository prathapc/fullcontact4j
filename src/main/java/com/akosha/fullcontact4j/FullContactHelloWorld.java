package com.akosha.fullcontact4j;
 ...
 * Here, lets take a business email (like, prathap.choudhury@gmail.com)
...
public class FullContactHelloWorld {
    ...
    //the first argument should be a business email with somebody's name (like prathap.choudhury@gmail.com!)
    public static void main(String[] args) {
        // create a client builder, set the user agent, and build the client
        client = FullContact.withApiKey("api key here ")
